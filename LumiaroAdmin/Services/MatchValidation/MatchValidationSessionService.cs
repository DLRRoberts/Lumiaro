...
public sealed class MatchValidationSessionService : IMatchValidationSessionService
{
    ...
    public Task InitializeAsync(MatchInfo matchInfo, Squad homeSquad, Squad awaySquad, CancellationToken ct = default)
    {
        _session = BuildFreshSession(matchInfo, homeSquad, awaySquad);
        Notify();
